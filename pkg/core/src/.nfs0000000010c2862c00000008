...
public:
	...
	GENERATION_STATUS patternGeneration(Fault fault);
...
protected:
    ...
    Gate* initialize(Fault& fault,int& BackImpLevel,IMP_STATUS& implyStatus);
    void initialList(bool initFlag);
    void initialNetlist(Gate& gFaultyLine);
