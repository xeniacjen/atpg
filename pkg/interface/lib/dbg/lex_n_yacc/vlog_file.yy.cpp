...
YY_BUFFER_STATE vlog_file_scan_bytes (yyconst char *bytes,int len  );
...
#line 674 "lib/dbg/lex_n_yacc/vlog_file.yy.cpp"
...
#line 861 "lib/dbg/lex_n_yacc/vlog_file.yy.cpp"
...
ECHO;
	YY_BREAK
#line 1179 "lib/dbg/lex_n_yacc/vlog_file.yy.cpp"
 ...
 * @return the newly allocated buffer state object.
 */
YY_BUFFER_STATE vlog_file_scan_bytes  (yyconst char * yybytes, int  _yybytes_len )
{
	YY_BUFFER_STATE b;
	char *buf;
	yy_size_t n;
